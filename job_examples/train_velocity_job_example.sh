...
TENSORBOARD="${TENSORBOARD:-auto}"
TENSORBOARD_DIR="${TENSORBOARD_DIR:-$OUTPUT_DIR/tensorboard}"
ORDINAL_LOSS_WEIGHT="${ORDINAL_LOSS_WEIGHT:-0}"
MIN_NOTES_PER_SEQUENCE="${MIN_NOTES_PER_SEQUENCE:-8}"
...
cmd=(
  ...
  --min_notes_per_sequence "$MIN_NOTES_PER_SEQUENCE"
)
